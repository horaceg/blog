...
| ![tSNE projection of a 20-dimensional latent space for VAE and AE](vae-vs-ae-tsne-mnist.png) |
| :--------------------------------------------------------------------------------------------------: |
...
|                                          <p align="center"><img src="vae-summary.png" width="400" alt="Concept of VAE"></p>                                          |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
...
![Simple schematic of computational flow in a variational autoencoder.](vae-tiger.png)
...
| ![Reparameterization trick](vae-reparam.png) |
| :--------------------------------------------------: |
...
|       ![VAE Algorithm](vae-algo-elbo.png)       |
| :-----------------------------------------------------: |
...
| <p align="center"><img src="vae-chemical-design.png" width="400" alt="VAE Chemical design"></p> |
| :-----------------------------------------------------------------------------------------------------: |
...
| ![VAE Smile vector](vae-smile-vector.png) |
| :-----------------------------------------------: |
