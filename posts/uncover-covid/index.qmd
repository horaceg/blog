...
categories : ["machine learning", "probability", "bayes", "epidemiology", "kaggle", "probabilistic programming"]
---

![A diagram of the overall workflow](diagram_bayes_epi.png)
...
- An estimation of the effective reproduction number $R_t$ as a function of mobility data and reported deaths
