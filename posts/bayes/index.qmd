...
date : 2024-04-24
toc : true
categories : ["probability", "bayes", "inference", "statistics"]
---
...
![Only known portait of possibly Thomas Bayes. 18th century](thomas-bayes.png)
...
![Meme about MLE, MAP and posterior sampling](meme-inferences.png)
...
![Meme about Maximum likelihood vs sampling from the posterior](meme-drake-mle-posterior-sampling.png)
...
![Meme about asking for posterior samples](meme-bernie-asking-post-samples.png)
...
![Beta prior](beta-prior/bayes_6_1.svg)
...
![Beta posterior](beta-prior/bayes_9_2.svg)
...
![Posterior probability of heads under a beta prior](beta-prior/bayes_11_1.svg)
