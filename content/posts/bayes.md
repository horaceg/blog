...
Let $p(\theta)$ denote the distribution of $\theta$. More rigorously, $p$ in this post loosely denotes either the probability of an event or the probability density (or probability mass function) of a random variable. When I write _distribution_ it often means density of the random variable.
